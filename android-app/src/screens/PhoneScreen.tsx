...
const PhoneScreen = ({ navigation }: Props): React.JSX.Element => {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: '👥',
      name: 'Accès Contacts',
      description: 'Enrichissement caller ID via contacts',
    ...
    },
    {
      ...
      description: 'Analyse historique pour détection spam/scam',
    ...
    },
    {
      ...
      description: 'Lecture SMS pour détection phishing',
