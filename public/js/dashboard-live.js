...
(function() {
    ...
    const DashboardLive = {
        ...
        createLiveSection: function() {
            ...
            const networkClass = navigator.onLine ? 'green' : 'red';
            const networkIcon = navigator.onLine ? '✓' : '✗';
            const networkText = navigator.onLine ? 'En ligne' : 'Hors ligne';
            ...
            container.innerHTML = `
                <div class="section">
                    ...
                    <div style="margin-top: 1.5rem; display: flex; gap: 1rem; align-items: center;">
                        <button onclick="DashboardLive.refreshInfo()" class="btn btn-primary">
        ...
        updateNetworkStatus: function() {
            ...
            // Recrée la section pour mettre à jour les badges
            this.createLiveSection();
