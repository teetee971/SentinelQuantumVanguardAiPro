...
object ExternalMessagingLinks {
    ...
    /** Pure validation/building helper for local JVM tests. */
    fun url(service: Service, publicHandle: String): String? {
        ...
        return when (service) {
            ...
            // Signal and Discord do not have a generic, privacy-safe username URL contract
            // Sentinel can assume here. They remain unavailable until an explicit supported
            // destination is supplied by the user/platform.
