...
class SentinelCallScreeningService : CallScreeningService() {
    override fun onScreenCall(callDetails: Call.Details) {
        ...
        val responseLatencyMs = (SystemClock.elapsedRealtimeNanos() - screeningStartedNs) / 1_000_000L
        ...
        LocalLogger(this).log(
            ...
            "CallScreening",
            "Décision=${decision.action} source=${decision.source} motif=${decision.reason} response_latency_ms=$responseLatencyMs"
        )
